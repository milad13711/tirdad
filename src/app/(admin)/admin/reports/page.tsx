...
export default async function AdminReportsPage() {
  ...
  const [freePromptCount, premiumPromptCount, monthlyOrders, campaigns, inboundByProvider, smsSettings] =
    await Promise.all([
  ...
  return (
    <div>
      <PageHeader title="گزارش‌ها" description="گزارش‌های تفصیلی درآمد، پیام‌رسان‌ها و مارکتینگ" />
